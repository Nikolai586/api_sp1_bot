...
#proxy = telegram.utils.request.Request(proxy_url='socks5://97.74.6.64:5589')
...
def send_message(message):
    proxy_url = telegram.utils.request.Request(proxy_url=proxy)
    bot = telegram.Bot(token=TELEGRAM_TOKEN, request=proxy_url)
